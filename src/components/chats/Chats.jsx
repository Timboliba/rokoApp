    ...
    <>
      ...
      >
        ...
        <div className="nameAndLastChat">
          <h2 style={{ padding: "0", margin: "0" }}>{item.nom}</h2>
        ...
        >
          ...
          >
            <img
              ...
              style={{ height: "50px", width: "50px", borderRadius: "50%" }}
            />
            <h2 style={{ padding: "0", margin: "0" }}>Teste Teste</h2>
          </div>
          <div className="btnUpdate" style={{ padding: "0 10px 5px 30px" }}>
            <button style={{ height: "50px", borderRadius: "10px" }}>
              MODIFIER LA LISTE DES PRODUITS PERSONNALISEE
            </button>
          </div>
        </div>
        <div
          className="discutionContaint"
          style={{ overflowY: "scroll", height: "585px",scrollbarWidth:'thin' }}
        >
